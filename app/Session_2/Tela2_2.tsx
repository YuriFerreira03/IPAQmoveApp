...
const Tela2_2: React.FC<{ route: TelaLocalizacaoRouteProp }> = ({ route }) => {
  ...
  const fetchQuestao = async () => {
    try {
      ...
      const url = `/questao/8`; // Passando o id_questao diretamente so colocar o numero de acordo com o banco
      ...
      <LinearGradient colors={["#032D45", "#0A4E66"]} style={styles.container}>
        <ScrollView contentContainerStyle={styles.scrollView}>
          ...
          <Text style={styles.body}>
            ...
            lugar para outro, incluindo seu trabalho, escola, cinema, lojas e
            outros por{" "}
