...
type TelaLocalizacaoRouteProp = RouteProp<RootStackParamList, "tela4_2">;

const Tela4_2: React.FC<{ route: TelaLocalizacaoRouteProp }> = ({ route }) => {
  ...
  const fetchQuestao = async () => {
    try {
      ...
      const url = `/questao/10`; // Passando o id_questao diretamente so colocar o numero de acordo com o banco
  ...
  const handleRegister = async () => {
    ...
    try {
      if (isChecked) {
        console.log("Checkbox marcado, navegando para Tela6_2");
        navigation.navigate("Tela6_2"); // Navega para Tela3_2 se o checkbox estiver marcado
      ...
      console.log("Enviando dados para o backend:", {
        ...
        fk_Questionario_id_questao: 10, // Substitua pelo ID da questão correta
      ...
      const dadosParaEnvio = {
        fk_Usuario_id_usuario: userId, // Utilize o ID do usuário logado
        fk_Questionario_id_questao: 10, // Sempre define com o id da questao
      ...
      console.log("Navegando para Tela5_2");
      setSearchName("");
      navigation.navigate("Tela5_2");
    } catch (error) {
