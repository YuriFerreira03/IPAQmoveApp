...
type TelaLocalizacaoRouteProp = RouteProp<RootStackParamList, "tela2_3">;

const Tela2_3: React.FC<{ route: TelaLocalizacaoRouteProp }> = ({ route }) => {
  ...
  const handleRegister = async () => {
    try {
      if (isChecked) {
        console.log("Checkbox marcado, navegando para Tela4_3");
        navigation.navigate("Tela4_3"); // Navega para Tela3_2 se o checkbox estiver marcado
      ...
      console.log("Enviando dados para o backend:", {
        ...
        fk_Questionario_id_questao: 14, // Substitua pelo ID da questão correta
      ...
      const dadosParaEnvio = {
        fk_Usuario_id_usuario: userId, // Utilize o ID do usuário logado
        fk_Questionario_id_questao: 14, // Sempre define com o id da questao
      ...
      console.log("Navegando para Tela3_3");
      setSearchName("");
      navigation.navigate("Tela3_3");
    } catch (error) {
