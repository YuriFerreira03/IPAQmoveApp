...
const Tela5_4: React.FC<{ route: TelaLocalizacaoRouteProp }> = ({ route }) => {
  ...
  const fetchQuestao = async () => {
    try {
      ...
      const url = `http://${ip}:8080/questao/24`; // Passando o id_questao diretamente so colocar o numero de acordo com o banco
  ...
  const handleRegister = async () => {
    ...
    try {
      if (isChecked) {
        ...
        navigation.navigate("Splach5"); // Navega para Tela3_4 se o checkbox estiver marcado
      ...
      console.log("Enviando dados para o backend:", {
        ...
        fk_Questionario_id_questao: 24, // Substitua pelo ID da questão correta
      ...
      const dadosParaEnvio = {
        fk_Usuario_id_usuario: userId, // Utilize o ID do usuário logado
        fk_Questionario_id_questao: 24, // Sempre define com o id da questao
