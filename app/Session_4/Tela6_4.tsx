...
type TelaLocalizacaoRouteProp = RouteProp<RootStackParamList, "Tela6_4">;

const Tela6_4: React.FC<{ route: TelaLocalizacaoRouteProp }> = ({ route }) => {
  ...
  const fetchQuestao = async () => {
    try {
      ...
      const url = `http://${ip}:8080/questao/25`; // Passando o id_questao diretamente so colocar o numero de acordo com o banco
