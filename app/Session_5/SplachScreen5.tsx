...
const SplashScreen5 = () => {
  ...
  const secaoId = 5; //estabelecendo a constante da minha seção com o valor do meu id desejado
  ...
  useEffect(() => {
    const fetchSecao = async () => {
      try {
        ...
        const url = `http://${ip}:8080/secao/${secaoId}`; //pegando a seção 3 no banco de dados
