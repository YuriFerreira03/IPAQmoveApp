...
const Tela1_5: React.FC<{ route: TelaLocalizacaoRouteProp }> = ({ route }) => {
  ...
  const fetchQuestao = async () => {
    try {
      ...
      const url = `http://${ip}:8080/questao/26`; // Passando o id_questao diretamente so colocar o numero de acordo com o banco
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      console.log("Enviando dados para o backend:", {
        ...
        fk_Questionario_id_questao: 26, // Substitua pelo ID da questão correta
      ...
      const dadosParaEnvio = {
        fk_Usuario_id_usuario: userId, // Utilize o ID do usuário logado
        fk_Questionario_id_questao: 26, // Sempre define com o id da questao
    ...
    >
      <LinearGradient colors={["#032D45", "#0A4E66"]} style={styles.container}>
        ...
        <Text style={styles.body}>
          ...
          todo dia, no trabalho, na escola ou faculdade, em casa e durante seu
          tempo livre. Isto inclui o tempo sentado estudando, sentado enquanto
          descansa, fazendo lição de casa visitando um amigo, lendo, sentado ou
          deitado assistindo TV. Não inclua o tempo gasto sentando durante o
