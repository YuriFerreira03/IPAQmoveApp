...
type TelaLocalizacaoRouteProp = RouteProp<RootStackParamList, "Tela2_5">;

const Tela2_5: React.FC<{ route: TelaLocalizacaoRouteProp }> = ({ route }) => {
  ...
  const fetchQuestao = async () => {
    try {
      ...
      const url = `http://${ip}:8080/questao/27`; // Passando o id_questao diretamente so colocar o numero de acordo com o banco
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      console.log("Enviando dados para o backend:", {
        ...
        fk_Questionario_id_questao: 27, // Substitua pelo ID da questão correta
      ...
      const dadosParaEnvio = {
        fk_Usuario_id_usuario: userId, // Utilize o ID do usuário logado
        fk_Questionario_id_questao: 27, // Sempre define com o id da questao
